...
void create_learning_block_dialog(BuildContext context) {
	showDialog(
		context: context,
								...
								child: InkWell(
									onTap: () {
										final MutationOptions options = MutationOptions(
											document: gql(addLearningBlockToSubunit),
											variables: <String, dynamic> {
												'subunitId': '1',
												'semanticName': nameController.text,
												'semanticDescription': descriptionController.text,
											}
										);
										...
										result.then((info) {
											...
											String url = info.data?['addLearningBlockToSubunit']['url']['nextUrl'];
